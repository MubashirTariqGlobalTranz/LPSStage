...
/*
 * @Test public void createLoadTest() {
 * 
 * 
 * 
 * 
 * 
 * // fill out the required fields /*try { Thread.sleep(10000); } catch
 * (InterruptedException e) { // TODO Auto-generated catch block
 * e.printStackTrace(); } loadPage.enterCustomerName("106637"); try {
 * Thread.sleep(3000); } catch (InterruptedException e) { // TODO Auto-generated
 * catch block e.printStackTrace(); }
 * loadPage.enterContactName("AutomationTest");
 * loadPage.enterPhone("(919) 304-3846"); loadPage.enterReferenceNo("1234567");
 * 
 * 
 * // submit the form loadPage.submitLoad();
 * 
 * // verify that the load was created successfully
 * //Assert.assertTrue(loadPage.isLoadCreated()); }
 * 
 * @AfterTest public void tearDown() { // close the WebDriver driver.quit(); }
 */
